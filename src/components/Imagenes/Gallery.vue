  ...
  >
    <div class="p-4">
      ...
      <div
        ...
        class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 auto-rows-min"
      >
        <div
...
const deleteImage = async (imageId: string, imageUrl: string) => {
  try {
    ...
    const response = await ImagenService.eliminarImagenDeGaleria(authStore.getToken, imageId)
    console.log(response)
