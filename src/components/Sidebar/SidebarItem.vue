...
<template>
  <li>
    <router-link
      :to="item.route"
      class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-crimsonDark dark:hover:bg-meta-4"
      @click.prevent="handleItemClick"
      :class="{
        'bg-crimsonDark dark:bg-meta-4': sidebarStore.page === item.label
      }"
    >
